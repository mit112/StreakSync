...
final class SocialModelTests: XCTestCase {
    ...
    func testOtherUserId_asSender() {
        let f = Friendship(
            id: "f1", userId1: "alice", userId2: "bob",
            status: .accepted, createdAt: Date(),
            senderDisplayName: nil, recipientDisplayName: nil
        )
    ...
    func testFriendshipStatus_pending() {
        let f = Friendship(
            id: "f1", userId1: "a", userId2: "b",
            status: .pending, createdAt: Date(),
            senderDisplayName: "Alice", recipientDisplayName: nil
        )
