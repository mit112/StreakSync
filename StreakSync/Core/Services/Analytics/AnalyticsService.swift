 ...
 * - Calculates streak consistency: percentage of days with ≥1 result within time range
 * - Computes completion rates: completed results ÷ total results within time range
